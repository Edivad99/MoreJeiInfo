...
public class Config {
  ...
  private static void assignConfigs() {
    ...
    enchantabilityTooltipMode = CONFIG.getEnumOrDefault("enum.enchantability", Mode.ON_DEBUG, Mode.class);
    foodTooltipMode = CONFIG.getEnumOrDefault("enum.foodTooltip", Mode.ON_DEBUG, Mode.class);
    maxStackSizeTooltipMode = CONFIG.getEnumOrDefault("enum.maxStackSize", Mode.ON_DEBUG, Mode.class);
    nbtTooltipMode = CONFIG.getEnumOrDefault("enum.nbtTooltip", Mode.ON_DEBUG, Mode.class);
    registryNameTooltipMode = CONFIG.getEnumOrDefault("enum.registryName", Mode.DISABLED, Mode.class);
    tagsTooltipMode = CONFIG.getEnumOrDefault("enum.tags", Mode.ON_DEBUG, Mode.class);
    translationKeyTooltipMode = CONFIG.getEnumOrDefault("enum.translationKey", Mode.ON_DEBUG, Mode.class);
